...
\cleardoublepage\include{Chapters/Verwandte Arbeiten} 
\cleardoublepage\include{Chapters/Aufbau}
\cleardoublepage\include{Chapters/Umsetzung}           % <<< Hier alle Chapter der Abschlussarbeit (einzeln) einbinden
\cleardoublepage\include{Chapters/Diskussion}
\cleardoublepage\include{Chapters/Manual}
\cleardoublepage\include{Chapters/UserTest}
